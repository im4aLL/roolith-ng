...
```ts
import { LoaderComponent, InlineLoaderComponent, LoaderService } from 'roolith-ng';
```
...
```ts
import { LoaderService } from 'roolith-ng';
...
```ts
import { InlineLoaderComponent } from 'roolith-ng';
```
