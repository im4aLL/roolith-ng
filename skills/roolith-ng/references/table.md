...
```ts
import { TableComponent } from '@im4all/roolith-ng';
// or import the full set of table sub-components
import { IMPORT_TABLE } from '@im4all/roolith-ng';
```
...
```ts
import { ITableColumn, ITableData } from '@im4all/roolith-ng';
...
```ts
import { ITableColumn } from '@im4all/roolith-ng';
...
```ts
import { ITableColumn, ITableCellClickEvent } from '@im4all/roolith-ng';
...
```ts
import { ITableColumn, ITableCellEditEvent } from '@im4all/roolith-ng';
...
```ts
import { ITableColumn, TableCellDirective } from '@im4all/roolith-ng';
...
```ts
import { TableExporter, TableCsvExportStrategy, TableJsonExportStrategy, ITableExportStrategy } from '@im4all/roolith-ng';
```
...
```ts
import { ITableExportStrategy, ITableColumn, ITableData } from '@im4all/roolith-ng';
