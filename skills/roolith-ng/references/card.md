...
```ts
import { CardComponent, CardActionDirective, CardFooterDirective } from '@im4all/roolith-ng';
// or
import { IMPORT_CARD } from '@im4all/roolith-ng';
```
...
```ts
import { CardComponent, CardActionDirective } from '@im4all/roolith-ng';
...
```ts
import { CardComponent, CardFooterDirective } from '@im4all/roolith-ng';
...
```ts
import { ButtonComponent, CardActionDirective, CardComponent, CardFooterDirective } from '@im4all/roolith-ng';
